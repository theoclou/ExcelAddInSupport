...
exports.ConfigurableProperties = exports.SupportedChannelTypes = exports.Activities = exports.GraphConnector = exports.WebApplicationInfo = exports.DevicePermissions = exports.Permissions = exports.ScopeConstraints = exports.ComposeExtensions = exports.SubscriptionOffer = exports.Connectors = exports.Bots = exports.StaticTabs = exports.ConfigurableTabs = exports.Icons = exports.Description = exports.Name = exports.Developer = exports.LocalizationInfo = exports.MosManifestManifestVersion = exports.BotConfiguration = exports.DashboardCardContentSourceSourceType = exports.DashboardCardDefaultSize = exports.ExtensionRibbonsCustomMobileControlButtonItemType = exports.ExtensionCommonCustomControlMenuItemType = exports.ExtensionCommonCustomControlMenuType = exports.ExtensionCommonCustomGroupControlsItemType = exports.Position = exports.ExtensionRuntimesActionsItemType = exports.FormFactors = exports.Scopes = exports.Capabilities = exports.MosManifest = exports.DashboardCardContentSource = exports.DashboardCardIcon = exports.DashboardCard = exports.ExtensionCommonIcon = exports.ExtensionCommonSuperToolTip = exports.ExtensionCustomMobileIcon = exports.ExtensionRibbonsCustomMobileControlButtonItem = exports.ExtensionCommonCustomControlMenuItem = exports.ExtensionCommonCustomControlMenu = exports.ExtensionRibbonsCustomMobileGroupItem = exports.ExtensionCommonCustomGroupControlsItem = exports.ExtensionCommonCustomGroup = exports.ExtensionRibbonsCustomTabGroupsItem = exports.ExtensionRibbonsArrayTabsItem = exports.ExtensionRuntimesActionsItem = exports.RequirementsExtensionElement = exports.TaskInfo = void 0;
exports.ApiSecretServiceAuthConfiguration = exports.MicrosoftEntraConfiguration = exports.Authorization2AuthType = exports.Commands2 = exports.Scopes6 = exports.GroupChat = exports.Team = exports.Handlers = exports.Icons2 = exports.ActionsIntent = exports.Alternates = exports.ContextMenus = exports.AutoRunEvents = exports.Ribbons = exports.Runtimes = exports.GetStartedMessages = exports.Permissions2 = exports.VideoFilters = exports.Scenes = exports.DefaultGroupCapabilityMeetings = exports.DefaultGroupCapabilityGroupchat = exports.DefaultGroupCapabilityTeam = exports.ActivityTypes = exports.GroupChats = exports.Teams = exports.MessageHandlers = exports.Commands = exports.Authorization2 = exports.ComposeExtensionsComposeExtensionType = exports.Scopes5 = exports.CommandLists = exports.Scopes4 = exports.Configuration = exports.SupportedPlatform2 = exports.Context2 = exports.Scopes3 = exports.SupportedSharePointHosts = exports.SupportedPlatform = exports.Context = exports.MeetingSurfaces = exports.Scopes2 = exports.AdditionalLanguages = exports.PositionAlign = exports.IntuneInfo = exports.Actions = exports.Extensions = exports.Authorization = exports.MeetingExtensionDefinition = exports.DefaultGroupCapability = exports.MosManifestDefaultInstallScope = void 0;
exports.OptionsSendMode = exports.Parameters2 = exports.DialogInfoDialogType = exports.File = exports.CustomOfficeAddin = exports.StoreOfficeAddin = exports.XllCustomFunctions = exports.ComAddin = exports.MenusType = exports.Options = exports.ResourceSpecificType = exports.Choices = exports.ParametersInputType = exports.BotInfo = exports.DialogInfo = exports.PageInfo = exports.SupportedObjects = exports.HandlersType = exports.AlternateIcons = exports.Hide = exports.Prefer = exports.Menus = exports.Events = exports.Contexts = exports.RuntimesLifetime = exports.Code = exports.RuntimesType = exports.ResourceSpecific = exports.Value = exports.MessageHandlersType = exports.Parameters = exports.Context3 = exports.CommandsType = void 0;
class TaskInfo {
    constructor(data) {
        if (data) {
...
class MosManifest {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["actions"])) {
                ...
                for (let item of _data["actions"])
                    this.actions.push(Actions.fromJS(item));
            }
            ...
            this.intuneInfo = _data["intuneInfo"] ? IntuneInfo.fromJS(_data["intuneInfo"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data) {
        ...
        data["intuneInfo"] = this.intuneInfo ? this.intuneInfo.toJSON() : undefined;
        return data;
    }
}
...
})(MosManifestManifestVersion || (exports.MosManifestManifestVersion = MosManifestManifestVersion = {}));
...
class Icons {
    ...
    init(_data) {
        if (_data) {
            ...
            this.color32x32 = _data["color32x32"];
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data) {
        ...
        data["color32x32"] = this.color32x32;
        return data;
    }
}
exports.Icons = Icons;
    ...
    init(_data) {
        if (_data) {
            ...
            if (Array.isArray(_data["icons"])) {
                this.icons = [];
                for (let item of _data["icons"])
                    this.icons.push(Icons2.fromJS(item));
            }
            if (Array.isArray(_data["handlers"])) {
                this.handlers = [];
                for (let item of _data["handlers"])
                    this.handlers.push(Handlers.fromJS(item));
            }
        }
    }
    static fromJS(data) {
...
class IntuneInfo {
    ...
    init(_data) {
        if (_data) {
            this.supportedMobileAppManagementVersion = _data["supportedMobileAppManagementVersion"];
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
        let result = new IntuneInfo();
        result.init(data);
        return result;
    }
    toJSON(data) {
        data = typeof data === 'object' ? data : {};
        data["supportedMobileAppManagementVersion"] = this.supportedMobileAppManagementVersion;
        return data;
    }
}
exports.IntuneInfo = IntuneInfo;
var PositionAlign;
...
})(SupportedPlatform || (exports.SupportedPlatform = SupportedPlatform = {}));
...
})(SupportedPlatform2 || (exports.SupportedPlatform2 = SupportedPlatform2 = {}));
class Configuration {
    constructor(data) {
        if (data) {
            for (var property in data) {
    ...
    init(_data) {
        if (_data) {
            ...
            this.groupChat = _data["groupChat"] ? GroupChat.fromJS(_data["groupChat"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
...
class Alternates {
    constructor(data) {
        ...
        if (!data) {
            this.alternateIcons = new AlternateIcons();
        }
    }
    init(_data) {
        if (_data) {
            ...
            this.alternateIcons = _data["alternateIcons"] ? AlternateIcons.fromJS(_data["alternateIcons"]) : new AlternateIcons();
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
...
var ActionsIntent;
(function (ActionsIntent) {
    ActionsIntent["Create"] = "create";
    ActionsIntent["AddTo"] = "addTo";
    ActionsIntent["Open"] = "open";
    ActionsIntent["Preview"] = "preview";
    ActionsIntent["Share"] = "share";
    ActionsIntent["Sign"] = "sign";
    ActionsIntent["Custom"] = "custom";
})(ActionsIntent || (exports.ActionsIntent = ActionsIntent = {}));
class Icons2 {
    constructor(data) {
        if (data) {
            for (var property in data) {
...
class Handlers {
    ...
    init(_data) {
        if (_data) {
            this.type = _data["type"];
            this.supportedObjects = _data["supportedObjects"] ? SupportedObjects.fromJS(_data["supportedObjects"]) : undefined;
            this.supportsMultiSelect = _data["supportsMultiSelect"];
            this.pageInfo = _data["pageInfo"] ? PageInfo.fromJS(_data["pageInfo"]) : undefined;
            this.dialogInfo = _data["dialogInfo"] ? DialogInfo.fromJS(_data["dialogInfo"]) : undefined;
            this.url = _data["url"];
            this.botInfo = _data["botInfo"] ? BotInfo.fromJS(_data["botInfo"]) : undefined;
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
        let result = new Handlers();
        result.init(data);
        return result;
    }
    toJSON(data) {
        data = typeof data === 'object' ? data : {};
        data["type"] = this.type;
        data["supportedObjects"] = this.supportedObjects ? this.supportedObjects.toJSON() : undefined;
        data["supportsMultiSelect"] = this.supportsMultiSelect;
        data["pageInfo"] = this.pageInfo ? this.pageInfo.toJSON() : undefined;
        data["dialogInfo"] = this.dialogInfo ? this.dialogInfo.toJSON() : undefined;
        data["url"] = this.url;
        data["botInfo"] = this.botInfo ? this.botInfo.toJSON() : undefined;
        return data;
    }
}
...
(function (HandlersType) {
    HandlersType["OpenURL"] = "openURL";
    HandlersType["OpenPage"] = "openPage";
    HandlersType["OpenDialog"] = "openDialog";
    HandlersType["OpenTaskpane"] = "openTaskpane";
    HandlersType["InvokeAPI"] = "invokeAPI";
    HandlersType["InvokeBot"] = "invokeBot";
...
class SupportedObjects {
    ...
    init(_data) {
        if (_data) {
            this.file = _data["file"] ? File.fromJS(_data["file"]) : undefined;
            this.folder = _data["folder"];
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
        let result = new SupportedObjects();
        result.init(data);
        return result;
    }
    toJSON(data) {
...
class PageInfo {
    ...
    init(_data) {
        if (_data) {
            ...
            this.subpageId = _data["subpageId"];
        }
    }
    static fromJS(data) {
        data = typeof data === 'object' ? data : {};
...
exports.File = File;
var DialogInfoDialogType;
(function (DialogInfoDialogType) {
    DialogInfoDialogType["Url"] = "url";
    DialogInfoDialogType["AdaptiveCard"] = "adaptiveCard";
})(DialogInfoDialogType || (exports.DialogInfoDialogType = DialogInfoDialogType = {}));
class Parameters2 {
    constructor(data) {
        if (data) {
            for (var property in data) {
